...
;@CLEAR_INT 0x0045946C+5, 0x0045947E ; Generate_Unit_Move_Order(int_int_int) - Invalid targetX ; Superseded by Mod__HandleGameLoopEvents
;@LJMP 0x0045946C, 0x00459531 ; Generate_Unit_Move_Order(int_int_int) - Invalid targetX ; Superseded by Mod__HandleGameLoopEvents
;@CLEAR_INT 0x00459496+5, 0x004594A8 ; Generate_Unit_Move_Order(int_int_int) - Invalid targetY ; Superseded by Mod__HandleGameLoopEvents
;@LJMP 0x00459496, 0x00459531 ; Generate_Unit_Move_Order(int_int_int) - Invalid targetY ; Superseded by Mod__HandleGameLoopEvents
