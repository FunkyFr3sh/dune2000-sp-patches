...
enum EventTypes
{
  ...
  // Bullet manipulation
  ET_SET_BULLET_PROPERTY,
  // Explosion manipulation
  ET_SET_EXPLOSION_PROPERTY,
  // Crate manipulation
  ET_REMOVE_CRATE,
  ET_PICKUP_CRATE,
  ...
  ET_109,
  // Game modifications
  ET_SET_UNIT_TEMPLATE_PROPERTY,
  ET_SET_BUILDING_TEMPLATE_PROPERTY,
  ET_SET_WEAPON_TEMPLATE_PROPERTY,
  ET_SET_EXPLOSION_TEMPLATE_PROPERTY,
  ET_SET_ARMOUR_VALUE,
  ET_SET_SPEED_VALUE,
  ET_SET_RULE,
  ET_117,
  ...
  ET_GET_OBJECT_POSITION,
  ET_GET_DIRECTION,
  ET_GET_POSITION_ON_CIRCLE,
  ET_GET_NEAREST_BUILDING_TILE,
  ET_GET_DISTANCE,
  ET_CHECK_DISTANCE,
  ET_196,
  ET_197,
