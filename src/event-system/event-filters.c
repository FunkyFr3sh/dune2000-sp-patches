...
bool CheckIfUnitMatchesCriteria(Unit *unit, eSideType side_id, eUnitFilterCriteriaType criteria_type, bool negation, bool comparison, int value)
{
  ...
  case UNITCRITERIATYPE_CATEGORY:
    ...
    case UNITCATEGORY_ALLY_SIDE:          result = (_gDiplomacy[(int)side_id][gSideId] == 0) && (side_id != gSideId); break;
    case UNITCATEGORY_ENEMY_SIDE:         result = (_gDiplomacy[(int)side_id][gSideId] == 1) && (side_id != gSideId); break;
    case UNITCATEGORY_NEUTRAL_SIDE:       result = (_gDiplomacy[(int)side_id][gSideId] == 2) && (side_id != gSideId); break;
    ...
    case UNITCATEGORY_ENEMY_ALLY_SIDE:    result = (unit->EnemyIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)unit->EnemySide] == 0) && (side_id != unit->EnemySide); break;
    case UNITCATEGORY_ENEMY_ENEMY_SIDE:   result = (unit->EnemyIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)unit->EnemySide] == 1) && (side_id != unit->EnemySide); break;
    case UNITCATEGORY_ENEMY_NEUTRAL_SIDE: result = (unit->EnemyIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)unit->EnemySide] == 2) && (side_id != unit->EnemySide); break;
    ...
    case UNITCATEGORY_ATTACKER_ALLY_SIDE:   result = (unit->__AttackerIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)unit->__AttackerSide] == 0) && (side_id != unit->__AttackerSide); break;
    case UNITCATEGORY_ATTACKER_ENEMY_SIDE:  result = (unit->__AttackerIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)unit->__AttackerSide] == 1) && (side_id != unit->__AttackerSide); break;
    case UNITCATEGORY_ATTACKER_NEUTRAL_SIDE:result = (unit->__AttackerIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)unit->__AttackerSide] == 2) && (side_id != unit->__AttackerSide); break;
    case UNITCATEGORY_OLD_SIDE_MY_SIDE:   result = (unit->Flags & UFLAGS_1000_DEVIATED) && unit->OldSide == gSideId; break;
    case UNITCATEGORY_OLD_SIDE_ALLY:      result = (unit->Flags & UFLAGS_1000_DEVIATED) && (_gDiplomacy[(int)side_id][(unsigned)unit->OldSide] == 0) && (side_id != unit->OldSide); break;
    case UNITCATEGORY_OLD_SIDE_ENEMY:     result = (unit->Flags & UFLAGS_1000_DEVIATED) && (_gDiplomacy[(int)side_id][(unsigned)unit->OldSide] == 1) && (side_id != unit->OldSide); break;
    case UNITCATEGORY_OLD_SIDE_NEUTRAL:   result = (unit->Flags & UFLAGS_1000_DEVIATED) && (_gDiplomacy[(int)side_id][(unsigned)unit->OldSide] == 2) && (side_id != unit->OldSide); break;
...
bool CheckIfBuildingMatchesCriteria(Building *building, eSideType side_id, eBuildingFilterCriteriaType criteria_type, bool negation, bool comparison, int value)
{
  ...
  case BUILDINGCRITERIATYPE_CATEGORY:
    ...
    case BUILDINGCATEGORY_ALLY_SIDE:        result = (_gDiplomacy[(int)side_id][gSideId] == 0) && (side_id != gSideId); break;
    case BUILDINGCATEGORY_ENEMY_SIDE:       result = (_gDiplomacy[(int)side_id][gSideId] == 1) && (side_id != gSideId); break;
    case BUILDINGCATEGORY_NEUTRAL_SIDE:     result = (_gDiplomacy[(int)side_id][gSideId] == 2) && (side_id != gSideId); break;
    ...
    case BUILDINGCATEGORY_ENEMY_ALLY_SIDE:      result = (building->EnemyIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)building->EnemySide] == 0) && (side_id != building->EnemySide); break;
    case BUILDINGCATEGORY_ENEMY_ENEMY_SIDE:     result = (building->EnemyIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)building->EnemySide] == 1) && (side_id != building->EnemySide); break;
    case BUILDINGCATEGORY_ENEMY_NEUTRAL_SIDE:   result = (building->EnemyIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)building->EnemySide] == 2) && (side_id != building->EnemySide); break;
    ...
    case BUILDINGCATEGORY_ATTACKER_ALLY_SIDE:   result = (building->__AttackerIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)building->__AttackerSide] == 0) && (side_id != building->__AttackerSide); break;
    case BUILDINGCATEGORY_ATTACKER_ENEMY_SIDE:  result = (building->__AttackerIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)building->__AttackerSide] == 1) && (side_id != building->__AttackerSide); break;
    case BUILDINGCATEGORY_ATTACKER_NEUTRAL_SIDE:result = (building->__AttackerIndex != -1) && (_gDiplomacy[(int)side_id][(unsigned)building->__AttackerSide] == 2) && (side_id != building->__AttackerSide); break;
    }
    break;
...
bool CheckIfSideMatchesCriteria(eSideType side_id, eSideFilterCriteriaType criteria_type, bool negation, bool comparison, int value)
{
  ...
  switch(criteria_type)
  {
    ...
    case SIDECRITERIATYPE_TECH:             result = CompareValue(_gMiscData.Tech[(int)side_id], value, comparison); break;
    case TILECRITERIATYPE_CATEGORY:
      switch(value)
      {
      case SIDECATEGORY_MY_SIDE:            result = side_id == gSideId; break;
      case SIDECATEGORY_ALLY_TO_MY_SIDE:    result = _gDiplomacy[(int)side_id][gSideId] == 0; break;
      case SIDECATEGORY_ENEMY_TO_MY_SIDE:   result = _gDiplomacy[(int)side_id][gSideId] == 1; break;
      case SIDECATEGORY_NEUTRAL_TO_MY_SIDE: result = _gDiplomacy[(int)side_id][gSideId] == 2; break;
      case SIDECATEGORY_AI_ENABLED:         result = _gAIArray[(int)side_id].__IsAI != 0; break;
      case SIDECATEGORY_PARTICIPATES_GAME:  result = side->__ParticipatesInGame != 0; break;
      case SIDECATEGORY_UNITS_EXIST:        result = _gUnitsExist[(int)side_id] != 0; break;
      case SIDECATEGORY_BUILDINGS_EXIST:    result = _gBuildingsExist[(int)side_id] != 0; break;
      }
      break;
    case SIDECRITERIATYPE_ALLY_TO:          result = _gDiplomacy[(int)side_id][value] == 0; break;
    case SIDECRITERIATYPE_ENEMY_TO:         result = _gDiplomacy[(int)side_id][value] == 1; break;
    case SIDECRITERIATYPE_NEUTRAL_TO:       result = _gDiplomacy[(int)side_id][value] == 2; break;
