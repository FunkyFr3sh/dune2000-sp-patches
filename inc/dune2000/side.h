...
typedef enum UnitFlags
{
  ...
  UFLAGS_80 = 0x80,
  UFLAGS_100_CARRYING = 0x100,
  UFLAGS_200 = 0x200,
  UFLAGS_400 = 0x400,
  UFLAGS_800_DELIVERING = 0x800,
  ...
  UFLAGS_200000_NOT_DRAWN = 0x200000,
  UFLAGS_400000 = 0x400000,
  UFLAGS_800000_SELFHEALING = 0x800000,
  UFLAGS_1000000_DRAWN_BEHIND_OBJECTS = 0x1000000,
...
typedef struct Unit
{
  ...
  uint8_t __UnitTurnDelayCounter;
  uint8_t __TurretTurnDelayCounter;
  ...
  char EnemySide;
  uint8_t __MakeSmokeTimeCounter;
  char __GroupID;
  uint8_t __SpecialPurpose;
  uint8_t LastAttacked;
  uint8_t LastFired;
  uint8_t LastMoved;
  uint8_t OldSide;
  uint8_t __DeviatedTimeCounter;
  uint8_t __DeadStateTimeCounter;
  char __AttackerSide;
...
typedef struct Building
{
  ...
  uint8_t __IsSelected;
  uint8_t __TurretTurnDelayCounter;
  uint8_t __ReloadDelayCounter_refinery;
  uint8_t __FlickerFrames;
  uint8_t __DirectionFrame;
  uint8_t SpecialPurpose; // Additional field for extended functionality (mod)
  uint8_t __DeadStateTimeCounter;
  uint8_t EnemySide;
  uint8_t __MakeSmokeTimeCounter;
...
typedef enum BulletFlags
{
  ...
  BULFLAGS_1000000_SYNCHRONIZED_INACCURACY = 0x1000000, // Additional flag for extended functionality (mod)
