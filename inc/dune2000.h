...
// AI
void __thiscall CAI__Init(CAI_ *this, eSideType side_id);
void __thiscall CAI__ActivateAI(CAI_ *this);
void __thiscall CAI__Do(CAI_ *this);
...
void __thiscall CAI__DoBuildBuildings(CAI_ *this);
void __thiscall CAI__DoProtection(CAI_ *this);
void __thiscall CAI__DoDefence(CAI_ *this);
int  __thiscall CAI__GetGroupStrength(CAI_ *this, char group_id, eTaskType task);
...
void __thiscall CAI__MonitorGroups(CAI_ *this, char a2);
char __thiscall CAI__GetBestBasePosition(CAI_ *this, _BYTE *x, _BYTE *y);
bool __thiscall CAI__GroupStable(CAI_ *this, char group_id, int a3, int a4);
char __thiscall CAI__RecentlyInAction(CAI_ *this, char a2);
...
void __thiscall CAI__DoSpecialWeapons(CAI_ *this);
bool __thiscall CAI__ItemReady(CAI_ *this, char behavior, char *item);
Building *__thiscall CAI__GetBestTarget(CAI_ *this, eSideType side_id, char unit_behavior);
void __thiscall CAI__DoSaboteur(CAI_ *this, char activate_ai);
